...
def get_meters(loc):
        ...
        meters=r.georadiusbymember(key,"tmp",.25,"mi")
...
def mapview():
	...
	markers3=convert_loc_to_markers([sfCenter, [37.78089,-122.40886],[37.78213,-122.41171]])
...
#	return render_template('example.html',mymap=mymap,sndmap=sndmap,thrdmap=thrdmap)
	#return render_template('example.html',title="Meter May I?")
